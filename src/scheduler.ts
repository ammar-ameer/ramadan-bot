...
async function sendDailyMessage(type: 'suhoor' | 'iftar') {
    ...
    console.log(`🚀 Sending Meal Plan for Day ${targetDay} (Scheduled for 5:22 PM IST)...`);
...
export function initScheduler() {
    ...
    // Schedule for 5:22 PM every day
    // Explicitly set timezone to Asia/Kolkata
    cron.schedule('22 17 * * *', () => {
        console.log('⏰ Triggering daily meal plan (5:22 PM IST)');
